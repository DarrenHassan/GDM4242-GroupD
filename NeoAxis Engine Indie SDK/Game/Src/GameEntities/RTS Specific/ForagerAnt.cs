...
{
    public class ForagerAntType : RTSUnitType
    {
    ...
    public class ForagerAnt : RTSUnit
    {
       ...
       Body mainBody;
        ...
        ForagerAntType _type = null; public new ForagerAntType Type { get { return _type; } }
